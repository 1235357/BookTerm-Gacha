"""
BookTerm Gacha - Text Normalizer Module
========================================

This module provides text normalization for consistent processing across
different character encodings and fullwidth/halfwidth variants.

Normalization Rules:
    1. Fullwidth to Halfwidth Conversion:
       - A-Z (U+FF21-FF3A) -> A-Z (U+0041-005A)
       - a-z (U+FF41-FF5A) -> a-z (U+0061-007A)
       - 0-9 (U+FF10-FF19) -> 0-9 (U+0030-0039)
    
    2. Halfwidth Katakana to Fullwidth:
       - ｱｲｳｴｵ... -> アイウエオ...
       - Includes voiced/semi-voiced marks
    
    3. Unicode NFKC Normalization:
       - Compatibility decomposition followed by canonical composition
       - Standardizes visually similar characters

Usage:
    from module.Normalizer import Normalizer
    
    normalized = Normalizer.normalize("Ｈｅｌｌｏ　Ｗｏｒｌｄ")
    # Result: "Hello World"

Why Normalization?
    Japanese and Chinese texts often contain mixed fullwidth/halfwidth
    characters. Normalizing ensures consistent NER extraction and
    prevents duplicate entries for visually identical terms.
